...
def test_get_profile_by_user_id(db_connection):
    db_connection.seed("seeds/roammates_seed.sql")
    repository = ProfileRepository(db_connection)
    assert repository.find_by_user_id(2) == Profile(2, 2, 'https://www.treasury.gov.ph/wp-content/uploads/2022/01/male-placeholder-image.jpeg', 'Daniel', '24', 'Male', 'Test bio Daniel')